...
Route::get('/autopilot', 'FrontendController@autopilot')->name('autopilot');
...
Route::group(['prefix' => 'user'], function () {
    ...
    Route::post('resendotp', 'HomeController@resendotp')->name('resendotp');
    Route::post('validateotp', 'HomeController@validateotp')->name('validateotp');
 ...
 //Giftcards
        ...
        Route::get('/deldepo/{id}', 'HomeController@deldepos')->name('deldepos');
        ...
        //Investment
        Route::get('new_investment', 'InvestmentController@newinv')->name('newinvestment');
        Route::post('new_investment', 'InvestmentController@newinv2')->name('selectinv');
        Route::get('preview_investment', 'InvestmentController@previewinv')->name('previewinv');
        Route::post('post_investment', 'InvestmentController@joinplan')->name('postinv');
        Route::get('my_investment', 'InvestmentController@myplans')->name('myplans');
        Route::get('view_progress/{id}', 'InvestmentController@viewmyplans')->name('viewinv');
...
Route::group(['prefix' => 'admin', 'middleware' => 'auth:admin'], function () {
    ...
    Route::get('/investplans', 'AdminController@investplans')->name('investplans');
    Route::get('/delplans/{id}', 'AdminController@delplan')->name('admin.inv.delete');
    Route::post('/updateplan', 'AdminController@updateplan')->name('updateplan');
    Route::post('/addplan', 'AdminController@addplan')->name('addplan');
    Route::get('/active-inv-plan', 'AdminController@activeinvplans')->name('activeinvplans');
    Route::get('/inactive-inv-plan', 'AdminController@inactiveinvplans')->name('inactiveinvplans');
    Route::get('/teminate-inv-plan/{id}', 'AdminController@terminateinv')->name('terminateinv');
    Route::get('/activate-inv-plan/{id}', 'AdminController@activateinv')->name('activateinv');
    Route::get('/inv-plan/{id}', 'AdminController@invview')->name('invview');
 ...
 Route::get('/approved-rej/{id}', 'MarketController@dealrej')->name('dealrej');
    ...
    Route::post('/add', 'GatewayController@addnew')->name('add.gateway');
   ...
   //Transfer
    ...
    //withdraw
    Route::get('/withdraw-method', 'WithdrawController@index')->name('withdrawal');
    Route::post('/withdrawals', 'WithdrawController@store')->name('add.withdraw.method');
    Route::get('/del_withdrawals/{id}', 'WithdrawController@deletewith')->name('del.withdraw.method');
