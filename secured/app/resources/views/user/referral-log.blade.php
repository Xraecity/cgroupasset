                                        ...
                                        <div class="card card-bordered card-stretch">
                                            <div class="card-inner-group">
                                                <div class="card-inner position-relative card-tools-toggle">
                                                     <div class="card-head"><h5 class="card-title card-title-md">Invite your friends and family to {{$gnl->sitename}} and receive $5 instantly. </h5></div><div class="card-text"><p> Each member has a unique {{$basic->sitename}} referral link to share with friends and family and receive a <strong>{{number_format($basic->refinv, $basic->decimal)}}%</strong> of your referral capital. If any one signs up with your referral link, he or she will be added to your referral program. Your referral link can be used to invite as many users as possible.</p></div
