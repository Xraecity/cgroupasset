                        ...
                        <div class="container-xl wide-lg">
                            <div class="nk-content-body">
                                <div class="buysell  ">
                                    ...
                                    <div class="buysell-title text-center"><h4 class="title">Withdraw Funds</h4></div>
                                    <div class="buysell-block">
                                     ...
                                     document.getElementById("slogan").innerHTML = $(identifier).data('id2');
                                            ...
                                            <div class="buysell-field form-group">
                                                <div class="form-label-group"><label class="form-label">Choose your payment option</label></div>
                                            ...
                                            <div class="buysell-field form-group">
                                                <div class="form-label-group"><label class="form-label" for="buysell-amount">Withdrawal amount</label></div>
