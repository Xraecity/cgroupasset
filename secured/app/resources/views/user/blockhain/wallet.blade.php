                                    ...
                                    <div class="nk-block-between-md g-4">
                                        ...
                                        <div class="nk-block-content">
                                            <ul class="nk-block-tools gx-3">
                                                ...
                                                <li class="btn-wrap">
                                                    <a href="#" data-toggle="modal" data-target="#receive-coin"  class="btn btn-icon btn-xl btn-dim btn-outline-success"><em class="icon ni ni-arrow-down-left"></em></a><span class="btn-extext">Receive</span>
                                                </li>
                                                <li class="btn-wrap">
