                                ...
                                <div class="nk-block">
                                    <div class="nk-block-head">
                                        <div class="nk-block-head-content">
                                            ...
                                            <div class="nk-block-des"><p>Secure your account with the following settings.</p></div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="card-inner">
                                                <div class="between-center flex-wrap flex-md-nowrap g-3">
                                                    <div class="nk-block-text">
                                                        ...
                                                        <p>You can save your activities, this will also display any unusual activity detected.</p>
                                                    </div>
                                            ...
                                            <div class="card-inner">
                                                <div class="between-center flex-wrap flex-md-nowrap g-3">
                                                    <div class="nk-block-text">
                                                        ...
                                                        <p>This will be required for withdrawals and transfer.</p>
                                                    </div>
                                                    <div class="nk-block-actions">
                                            ...
                                            <div class="card-inner">
                                                <div class="between-center flex-wrap flex-md-nowrap g-3">
                                                    <div class="nk-block-text">
                                                        ...
                                                        <p>
                                                            Secure your account with 2FA security. When it is activated you will need to enter not only your password, but also a special code using the authenticator app. You can receive this code via email or SMS on mobile app.
                                                        </p>
                                                    </div>
                                                    <div class="nk-block-actions">
                                        @if($user->gfa == 1)
