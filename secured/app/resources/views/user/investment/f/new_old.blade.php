                                                    ...
                                                    <div class="plan-item-card">
                                                        <div class="plan-item-head">
                                                            <div class="plan-item-heading">
                                                                ...
                                                                <p class="sub-text">Invest & Earn.</p>
                                                            </div>
                                                        ...
                                                        <div class="plan-item-body">
                                                            <div class="plan-item-desc card-text">
                                                                <ul class="plan-item-desc-list">
                                                                    ...
                                                                    <li><span class="desc-label">Referral Bonus</span> - <span class="desc-data">%{{number_format($data->referral, $basic->decimal)}}</span></li>
                                                                    <!--<li><span class="desc-label">Referral Bonus</span> - <span class="desc-data">{{$basic->currency_sym}}{{number_format($data->referral, $basic->decimal)}}</span></li>-->
                                                                    </ul>
