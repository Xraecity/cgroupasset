...
document.getElementById("buyrate").innerHTML = $(identifier).data('buy');
                                    ...
                                    document.getElementById("amount2").innerHTML = usd;
                                            ...
                                            <div class="buysell-field form-group">
                                                <div class="form-label-group"><label class="form-label" for="buysell-amount">Amount to Sell</label></div>
...
<div class="modal-body modal-body-lg"><div class="nk-block-head nk-block-head-xs text-center"><h5 class="nk-block-title">Confirm Order</h5><div class="nk-block-text"><div class="caption-text">You are about to sell <strong><a id="amount"></a> USD</strong> worth of <strong><a id="coins"></a></strong>*</div>
