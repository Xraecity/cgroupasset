...
<div class="card card-custom-s1 card-bordered"><div class="row no-gutters"><div class="col-lg-4"><div class="card-inner-group h-100"><div class="card-inner"><h5>You’re almost there</h5><p>You’re only a few clicks away.</p></div><div class="card-inner"><ul class="list list-step"><li class="list-step-done">Verify email address</li>
...
@endif
                                     ...
                                     </div><div class="nk-block-content"><div class="nk-block-content-head"><h4>Verify Your Identity</h4><span class="sub-text sub-text-sm text-soft">4 minutes</span></div><p>To comply with regulations, you will be required to complete identity verification (KYC/AML) by submitting valid proof of identity and address</p><ul class="list list-sm list-checked"><li>Personal details.</li>

<li> Upload a valid means of identification. <span>
<li>Provide residential address. <span>
...
<div class="nk-content nk-content-fluid  "><div class="container-xl  "><div class="nk-content-body"><div class="kyc-app col-md-12o"><div class="nk-block-head nk-block-head-lg wide-xs mx-auto"><div class="nk-block-head-content text-center"><h4 class="nk-block-title fw-normal">Begin your ID-Verification</h4> </div></div><div class="nk-block"><div class="card card-bordered"><div class="nk-kycfm"><div class="nk-kycfm-head"><div class="nk-kycfm-count">01</div><div class="nk-kycfm-title"><h5 class="title">Personal Details</h5><p class="sub-title">You can’t edit these details once form is submitted.</p></div></div><div class="nk-kycfm-content"><div class="nk-kycfm-note"><em class="icon ni ni-info-fill" data-toggle="tooltip" data-placement="right" title="Tooltip on right"></em><p>Carefully fill out the form with your personal details. You can’t edit these details once form is submitted.</p></div><div class="row g-4"><div class="col-md-6">
...
</div></div><div class="nk-kycfm-footer"><div class="form-group"><div class="custom-control custom-control-xs custom-checkbox"><input type="checkbox" class="custom-control-input" required id="tc-agree"><label class="custom-control-label" for="tc-agree">I Have Read The <a href="#">Terms </a> And <a href="#">conditions</a></label></div></div><div class="form-group"><div class="custom-control custom-control-xs custom-checkbox"><input required type="checkbox" class="custom-control-input" id="info-assure"><label class="custom-control-label" for="info-assure">My personal info is correct.</label></div></div><div class="nk-kycfm-action pt-2"><button type="submit" class="btn btn-lg btn-primary">Complete verification process</button></form>
