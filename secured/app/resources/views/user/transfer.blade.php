     ...
     <div class="nk-content nk-content-fluid">
                        <div class="container-xl wide-lg">
                            <div class="nk-content-body">
                                    ...
                                    <div class="buysell-title text-center"><h4 class="title">Transfer Funds</h4>
                                    <p class="lead text-primary">You currently have  <strong>{{$basic->currency}} {{number_format(Auth::user()->balance, $basic->decimal)}} </strong> in your deposit wallet. </p><p>To transfer funds from your wallet to a chainhashpro user, input receiver’s username and proceed to ‘amount to transfer’.</p><p>Kindly   <strong>ensure the receiver's  </strong> username <strong>is correct</strong> </p>
