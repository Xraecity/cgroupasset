...
<div class="col-lg-12"><div class="kyc-status card mx-lg-4"><div class="fcard-innr"><div class="status status-thank px-md-5"><div class="status-icon"><em class="ti ti-info"></em></div><span class="status-text large text-dark">Verification Pending</span><p class="px-md-5">We are still processing your identity verification. Once our team verified your indentity, you will be notified by email. You can also check your verification compliance status from this page.</p><a href="#"  data-toggle="modal" data-target="#pay-online"  class="btn btn-primary">View Upload</a></div></div></div></div>
