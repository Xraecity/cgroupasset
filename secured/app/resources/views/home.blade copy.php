                                                            ...
                                                            <div class="nk-wg7">
                                                                ...
                                                                <div class="nk-wg7-stats-group">
                                                                    <div class="nk-wg7-stats w-50">
                                                                        <div class="nk-wg7-title">Pending Deposit</div>
                                                ...
                                                <div class="row g-2">
                                                        ...
                                                        <div class="card-inner">
                                                            <div class="nk-wg7">
                                                                ...
                                                                <div class="nk-wg7-stats-group">
                                                                    ...
                                                                    <div class="nk-wg7-stats w-50">
                                                                        <div class="nk-wg7-title">Ethereum</div>
                                                                        @php
                                                                         $coinrate =  $totalinv*$usdrate;
                                                                        @endphp

                                                                        <div class="number">ETH {{number_format($coinrate/$rate, $basic->decimal)}} </div>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div class="col-sm-4 col-6">
                                                        ...
                                                        <div class="card-inner">
                                                            <div class="nk-wg7">
                                                                <div class="nk-wg7-stats">
                                                                    <div class="nk-wg7-title">Exchange Rate (ETH)</div>
                                                                    <div class="number-lg amount">$ {{number_format(1,2)}} </div>
                                                                </div>
                                                                <div class="nk-wg7-stats-group">
                                                                    <div class="nk-wg7-stats w-50">
                                                                        <div class="nk-wg7-title">{{$basic->currency}}</div>
                                                                        <div class="number">{{$basic->currency}} {{number_format($usdrate,2)}} </div>
                                                                    </div>
                                                                    <div class="nk-wg7-stats w-50">
                                                                        <div class="nk-wg7-title">Ethereum</div>
                                                                        <div class="number">ETH {{number_format($rate,2)}} </div>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div class="col-sm-4 col-12">
                                                        ...
                                                        <div class="card-inner">
                                                            <div class="nk-wg7">
                                                                <div class="nk-wg7-stats">
                                                                    <div class="nk-wg7-title">Return On Investment (Fiat)</div>
                                                                ...
                                                                <div class="nk-wg7-stats-group">
                                                                    ...
                                                                    @endphp
                                                                        <div class="nk-wg7-title">ROI (ETH)</div>
                                                                        <div class="number">ETH {{number_format($usd/$rate, $basic->decimal)}} </div>
                                                                    </div>
                                                                </div>
