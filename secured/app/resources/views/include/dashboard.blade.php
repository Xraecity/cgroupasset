...
<li class="nk-menu-item has-sub"><a href="#" class="nk-menu-link nk-menu-toggle"><span class="nk-menu-icon"><em class="icon ni ni-wallet"></em></span><span class="nk-menu-text">Deposit</span></a><ul class="nk-menu-sub"><li class="nk-menu-item"><a href="{{ route('depositcrypto') }}"  class="nk-menu-link"><span class="nk-menu-text">Deposit Funds</span></a></li><li class="nk-menu-item"><a href="{{route('user.depositLog')}}" class="nk-menu-link"><span class="nk-menu-text">Deposit Log</span></a></li> </ul></li>
...
<li class="nk-menu-item has-sub"><a href="#" class="nk-menu-link nk-menu-toggle"><span class="nk-menu-icon"><em class="icon ni ni-chart-up"></em></span><span class="nk-menu-text">Investment</span></a><ul class="nk-menu-sub"><li class="nk-menu-item"><a href="{{route('newinvestment')}}" class="nk-menu-link"><span class="nk-menu-text">New Investment</span></a></li>
<li class="nk-menu-item"><a href="{{route('myplans')}}" class="nk-menu-link"><span class="nk-menu-text">Investment Log</span></a></li>

</ul></li>

<li class="nk-menu-item"><a href="/estate.php" class="nk-menu-link"><span class="nk-menu-icon"><em class="icon ni ni-home"></em></span><span class="nk-menu-text">Real Estate</span></a></li>
...
@endif
 ...
 @if(Auth()->user()->gfa == 1 && Auth()->user()->gfatime < now())

                    <div class="modal-body modal-body-lg">
                    <br><br>
                        <div class="nk-block-head nk-block-head-xs text-center">
                            <h5 class="nk-block-title">Enter 2FA Password</h5>
                            <div class="nk-block-text">
                                <div class="caption-text">Dear {{Auth::user()->username}}, Please enter the One Time Password sent to your registered email address to proceed to page</div>
                                <span class="sub-text-sm">Please check your spam folder if mail is not found in inbox  </span>
<form method="POST" action="{{ route('resendotp') }}">
          				       {{csrf_field()}}

<div class="buysell-field form-action"><button type="submit"  class="btn btn-sm btn-lg btn-outline btn-primary" >Resend 2FA Code</button></form>
...
<div class="col-md-12">
<div class="input-item input-with-label"><label class="input-item-label text-exlight">Enter 2FA Password</label><input name="otp" class="form-control lg-number" type="password" placeholder="*****"> </div></div>




<div class="buysell-field form-action"><button type="submit"  class="btn btn-lg btn-outline btn-primary" >Validate Code</button></form>
...
@endif
 ...
 <div class="nk-footer nk-footer-fluid"><div class="container-fluid"><div class="nk-footer-wrap"><div class="nk-footer-copyright"> &copy; 2021 {{$basic->sitename}}  </div><div class="nk-footer-links"><ul class="nav nav-sm"><li class="nav-item"><a class="nav-link" href="#">Terms</a></li><li class="nav-item"><a class="nav-link" href="#">Faqs</a></li><li class="nav-item"><a class="nav-link" href="{{route('ticket')}}">Help</a></li></ul></div></div></div></div></div></div></div>
