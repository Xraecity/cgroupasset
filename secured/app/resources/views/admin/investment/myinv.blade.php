                                            ...
                                            <div class="nk-block-head-content">
                                                <ul class="nk-block-tools gx-3">
                                                    <li class="order-md-last">
                                                        <a href="#" class="btn btn-danger"><em class="icon ni ni-cross"></em> <span>Cancel this plan</span> </a>
                                                    </li>
                                                    <li>
                                        ...
                                        <div id="schemeDetails" class="nk-iv-scheme-details">
                                            <ul class="nk-iv-wg3-list">
                                                ...
                                                <li>
                                                    ...
                                                    <div class="lead-text">{{$plan->cycle}} Time(s)</div>
                                                </li>
                                                <li>
                                            ...
                                            <ul class="nk-iv-wg3-list">
                                                ...
                                                @endphp
                                                    ...
                                                    <div class="lead-text"><span class="currency currency-usd">{{$basic->currency}} {{number_format($return+$inv->amount,2)}}</span></div>
                                                </li>
                                                <li>
