...
<div class="page-content"><div class="container"><div class="content-area card"><div class="card-innr table-responsive"><div class="card-head"><h4 class="card-title">Closed Investments</h4></div>
...
<div class="data-state data-state-approved">
                                        ...
                                        </a></span><span class="sub sub-date">{{$data->created_at}}</span></div></div></td><td class="data-col dt-token"><span class="lead token-amount">{!! number_format($data->amount, $basic->decimal)  !!}</span><span class="sub sub-symbol">{{$basic->currency}}</span></td><td class="data-col dt-token"><span class="lead dt-token">{{App\Plan::whereId($data->plan)->first()->name}}</span></td><td class="data-col dt-token"><span class="lead user-info">{{$data->trx}}</span> </td><td class="data-col dt-type"><span class="dt-type-md badge badge-outline badge-success badge-md">Closed</span><span class="dt-type-sm badge badge-sq badge-outline badge-success badge-md">C</span></td><td class="data-col text-right"><div class="relative d-inline-block"><a href="#" class="btn btn-light-alt btn-xs btn-icon toggle-tigger"><em class="ti ti-more-alt"></em></a><div class="toggle-class dropdown-content dropdown-content-top-left"><ul class="dropdown-list"><li><a href="{{route('invview',$data->trx)}}"><em class="ti ti-eye"></em> View Process</a></li><li><a href="{{route('activateinv',$data->id)}}"><em class="ti ti-na"></em> Re-activate Process</a></li  </ul></div></div></td></tr><!-- .data-item -->
@endforeach
