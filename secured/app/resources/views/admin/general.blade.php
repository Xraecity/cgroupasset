...
<div class="row"><div class="col-md-6"><div class="input-item input-with-label"><label class="input-item-label text-exlight">Referral Investment Bonus</label><div class="relative"><span class="input-icon input-icon-right"><em class="ti ti-mobile"></em></span> <input type="text" class="input-bordered"  value="{{$general->refinv}}"
                                           onkeyup="this.value = this.value.replace (/^\.|[^\d\.]/g, '')"
                                           name="refinv"></div><span class="input-note">Input system referral investment bonus in %. </span></div></div>

<div class="col-md-6"><div class="input-item input-with-label"><label class="input-item-label text-exlight">Referral Deposit Bonus</label><div class="relative"><span class="input-icon input-icon-right"><em class="ti ti-mobile"></em></span> <input type="text" class="input-bordered"  value="{{$general->refdep}}"
                                           onkeyup="this.value = this.value.replace (/^\.|[^\d\.]/g, '')"
                                           name="refdep"></div><span class="input-note">Input system referral deposit bonus in %. </span></div></div>
...
<li><div class="input-item text-left"><input
       id="pma-cash1"                   class="input-checkbox input-checkbox-sm"                 type="checkbox"
                                       ...
                                       <li><div class="input-item text-left"><input
       id="pma-cashs1"                   class="input-checkbox input-checkbox-sm"                 type="checkbox"
                                       name="trade" {{ $general->trade == "1" ? 'checked' : '' }}><label for="pma-cashs1">investment System</label></div></li>
