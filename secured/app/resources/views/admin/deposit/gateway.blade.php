...
@section('body')
 ...
 <br> <div class="card-head"><h4 class="card-title">Payment Gateways</h4></div><table class="data-table dt-filter-init admin-tnx"><thead><tr class="data-item data-head"><th class="data-col dt-tnxno">Name</th> <th class="data-col dt-type"><div class="dt-type-text">Status</div></th><th class="data-col"></th></tr></thead><tbody>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                             ...
                                                             <div class="col-md-12">
                                                                <h6><strong>Minimum Deposit</strong></h6>
                                                                <input type="text" value="{{$gateway->minamo}}"
                                                                       class="input-bordered" id="name" name="minamo">
                                                            </div>

                                                             <div class="col-md-12">
                                                                <h6><strong>Maximum Deposit</strong></h6>
                                                                <input type="text" value="{{$gateway->maxamo}}"
                                                                       class="input-bordered" id="name" name="maxamo">
                                                            </div>

                                                             <div class="col-md-12">
                                                                <h6><strong>Fixed Charge</strong></h6>
                                                                <input type="text" value="{{$gateway->fixed_charge}}"
                                                                       class="input-bordered" id="name" name="chargefx">
                                                            </div>

                                                             <div class="col-md-12">
                                                                <h6><strong>Percentage Charge</strong></h6>
                                                                <input type="text" value="{{$gateway->percent_charge}}"
                                                                       class="input-bordered" id="name" name="chargepc">
                                                            </div>
                                                            <div class="col-md-6">
...
<!-- Modal for Edit button -->
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel"><i class="fa fa-bank"></i> <strong class="abir_act"></strong>Create New Payment Gateway </h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                </div>
              <form method="post" action="{{route('add.gateway')}}">
              <div class="modal-body">
							<label>Gateway Name</label><br/>
							<input class="form-control form-control-solid h-auto"  placeholder="Enter gateway name" type="text" name="name" required><br/>
								 <label>Gateway Slogan</label><br/>
								 <input class="form-control form-control-solid h-auto"  placeholder="Enter gateway slogan" type="text" name="slogan" required><br/>
								 <label>Minimum Deposit</label><br/>
            					  <input class="form-control form-control-solid h-auto"  placeholder="Enter minimum deposit" class="form-control" type="text" name="min" required><br/>
            					  <label>Maximum Deposit</label><br/>
								  <input class="form-control form-control-solid h-auto"  placeholder="Enter maximum deposit" type="text" name="max" required><br/>

								<label>Fixed Charge {{$basic->currency_sym}}</label><br/>
								<input class="form-control form-control-solid h-auto"   placeholder="Enter Fixed Deposit Charge" type="text" name="fixed" required><br/>
							<label>Percentage Charge (%)</label><br/>
								<input class="form-control form-control-solid h-auto"   placeholder="Enter Deposit Charge in %" type="text" name="percent" required><br/>
                               ...
                               <select class="form-control form-control-solid h-auto"   name="type">
			...
			<small class="text-primary">Enter Crypto Wallet Address if its a coin or bank/payment account details if its fiat</small>												 <textarea row="5" class="form-control form-control-solid h-auto"   type="text" name="details" required> </textarea><br/>
